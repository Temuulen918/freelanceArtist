...
const Filtering = async ({ params }: any) => {
    ...
    const chiglel = decodeURIComponent(params.shuultuur1);
    console.log("chiglel ni" + chiglel);
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {buteelData.filter((buteel: ButeelRecord) =>
                            ...
                            buteel.urlagChiglel === chiglel).map((buteel: ButeelRecord) => (
        ...
        if (session.type === 'holboo') {
            ...
            return (
                <div className='myform'>
                    ...
                    <div >
                        <label>
                            "{salbar}" салбарын "{chiglel}" чиглэлээр шүүсэн
                        </label>
                    </div>
