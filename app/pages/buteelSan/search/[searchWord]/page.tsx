...
const Searching = async ({ params }: any) => {
    'use server'

    const word = decodeURIComponent(params.searchWord)
    const buteelData = await searchbuteel(word);
            ...
            return (
                <div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <Head />
                        <tbody>
                            {buteelData.records.filter((buteel: ButeelRecord) =>
